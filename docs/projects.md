...
!!! tip "生成AIモデルの情報検索プロセスの特性解明：指示応答型から推論型への展開"
    近年、生成AIモデルを検索エージェントに応用する需要が高まっている。検索エージェントは利用者のニーズに対して、クエリ生成、検索結果からの文書選択、選択文書の適合性判定、クエリの書換え、など多様な検索行動を担う。したがって、この内部プロセスを正確に理解することで、エージェントのきめ細かな制御や性能のボトルネック発見が可能になると考えられる。本研究では、指示応答型から推論型までを包括した、生成AIモデルの検索プロセス全体を体系的に分析できる枠組みを構築する。これにより、モデルごとの情報検索プロセスの特性が理解できるようになると共に、従来の性能重視モデル評価に新たな判断軸を提供することが期待される。  
    Website: [https://kaken.nii.ac.jp/ja/grant/KAKENHI-PROJECT-26K03244/](https://kaken.nii.ac.jp/ja/grant/KAKENHI-PROJECT-26K03244/)

!!! tip "研究開発のためのクライアントサイド情報検索技術"
    本研究課題では、研究者のPC上で動作するクライアントサイドAIを用いて、研究活動や情報検索行動を常時モニタリングし、研究の発展に必要な情報を自律的に検索し提供する技術を開発します。これにより、プライバシーおよびセキュリティリスクを低減しつつ、研究者が意図して検索しようとする情報、意図して検索しないが有用な情報、研究の発展に資する情報を、適切なタイミングで研究者へ提供できるようにします。  
    Website: [https://www.jst.go.jp/kisoken/presto/project/1112114/1112114_2025.html](https://www.jst.go.jp/kisoken/presto/project/1112114/1112114_2025.html)
